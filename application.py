...
dbc.Row([
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            dbc.Row(
                dbc.Col(
                    dash_table.DataTable(id='datatable',style_cell={'textAlign': 'center'},),width={"size": 8,  "offset": 2}
    ...
    dbc.Row([
        dbc.Col(
            html.Img(src=app.get_asset_url('UPSTREAM_logo.png')),width={"size": 3,  "offset": 1},style={'textAlign':'right'}
        ),
        dbc.Col(
            html.P('Built by Upstream Applied Science Ltd.',className="footertext"),width=3

        ),
        dbc.Col(
            dbc.Button("Find out more", href='https://www.upstream-applied-science.com',color='danger'),width=4,style={'textAlign':'left'}
        )
     ],justify="center", align="center", className="h-50",style={'margin-top': '80px','margin-bottom': '30px'})
